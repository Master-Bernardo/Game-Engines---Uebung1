...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=conyon1&box=11.561523,64.561988,11.185076,64.400292
...
-----------
  ...
  * conyon1 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * conyon1 Height Map (SRTM30 Plus).png
